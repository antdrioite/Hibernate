...
import be.vdab.fuckingHibernate.entities.Verantwoordelijkheid;
...
public class JpaDocentRepositoryTest extends AbstractTransactionalJUnit4SpringContextTests {
    ...
    public void findByWeddeBetween() {
        ...
        docenten.forEach(docent -> {
            ...
            System.out.println(docent.getFamilienaam() + ':' + docent.getWedde() + ' ' +
    ...
    public void bijnaamToevoegen() {
        ...
        manager.flush();
        assertEquals("test", super.jdbcTemplate.queryForObject("select bijnaam from docentenbijnamen where docentid=?", String.class,
                docent.getId()));
    }
    @Test
    ...
    public void verantwoordelijkheidToevoegen() {
        ...
        assertEquals(verantwoordelijkheid.getId(),
                super.jdbcTemplate.queryForObject("select verantwoordelijkheidid from docentenverantwoordelijkheden " +
